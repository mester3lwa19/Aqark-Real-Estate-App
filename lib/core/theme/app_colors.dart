...
class AppSemanticColors {
  ...
  const AppSemanticColors({
    required this.textPrimary, required this.textSecondary, required this.textGray, required this.textDisabled, required this.textInverse, required this.textLink, required this.textLinkHover, required this.textButton,
    required this.surfacePrimary, required this.surfaceSecondary, required this.surfaceGray, required this.surfaceCard, required this.surfaceCardHover, required this.surfaceOverlay, required this.surfaceInverse, required this.surfaceBrandSubtle, required this.surfaceBackground,
    required this.actionPrimaryDefault, required this.actionPrimaryHover, required this.actionPrimaryPressed, required this.actionPrimaryDisabled, required this.actionSecondaryDefault, required this.actionSecondaryHover, required this.actionSecondaryPressed, required this.actionSecondaryDisabled,
    required this.borderDefault, required this.borderStrong, required this.borderSubtle, required this.borderFocused, required this.borderError,
    required this.statusSuccess, required this.statusSuccessSubtle, required this.statusSuccessHovered, required this.statusSuccessPressed,
    required this.statusError, required this.statusErrorSubtle, required this.statusErrorHovered, required this.statusErrorPressed,
    required this.statusWarning, required this.statusWarningSubtle, required this.statusWarningHovered, required this.statusWarningPressed,
    required this.statusInfo, required this.statusInfoSubtle,
    required this.propertyVerifiedBadge, required this.propertyFeaturedBadge, required this.propertyNewBadge, required this.propertyPriceHighlight,
    required this.inputBackground, required this.inputBorder, required this.inputPlaceholder,
  });
