...
class AddReviewVariablesBuilder {
  ...
  Deserializer<AddReviewData> dataDeserializer = (dynamic json) =>
      AddReviewData.fromJson(jsonDecode(json));
  Serializer<AddReviewVariables> varsSerializer = (AddReviewVariables vars) =>
...
class AddReviewReviewUpsert {
  ...
  AddReviewReviewUpsert({required this.userId, required this.movieId});
}
...
class AddReviewData {
  ...
  AddReviewData({required this.review_upsert});
}
...
class AddReviewVariables {
  ...
  @override
  int get hashCode =>
      Object.hashAll([movieId.hashCode, rating.hashCode, reviewText.hashCode]);
